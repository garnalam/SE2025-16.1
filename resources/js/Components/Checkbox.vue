    ...
    <label class="inline-flex items-center gap-3 text-sm text-slate-600">
        <span class="relative flex size-5 items-center justify-center">
            <input
                ...
                type="checkbox"
                :value="value"
                class="peer size-full appearance-none rounded-md border border-slate-300 bg-white transition focus:outline-none focus:ring-2 focus:ring-sky-400/40"
            >
            <span class="pointer-events-none absolute inset-1 rounded-sm bg-gradient-to-br from-sky-400 via-cyan-400 to-indigo-500 opacity-0 transition peer-checked:opacity-100"></span>
