                    ...
                    <div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-700 border-dashed rounded-xl hover:border-cyan-500 transition-colors bg-slate-900/50 group">
                            <div class="space-y-1 text-center">
                                ...
                                <img v-else :src="URL.createObjectURL(form.image)" class="mx-auto h-32 rounded object-contain border border-cyan-500/50">
...
<style>
/* Include style block for multiselect in creating layout as well */
